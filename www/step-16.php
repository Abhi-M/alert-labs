...
xecscrip|addimpor)t|(?:fromcharcod|cooki)e|innerhtml)|\@import)\b)/', '', $name);
			...
			echo '<form name="myForm" action="step-16.php" onsubmit="return validateForm()" method="post">
...
?>
      ...
      <div style="color:#ecf0f1;width:50%;">
        <br>We have the following RegEx:<br>
