    ...
    <div class="siimple-grid">
      <div class="siimple-grid-row">
		...
		if (isset($_POST['fname'])) {
			...
			$name =  $_POST['fname'];
      $handle = fopen("step-09-list.csv", "a");
	     $line = array($name);
       fputcsv($handle, $line);
       fclose($handle);
			...
			echo '<form name="myForm" action="step-09.php" action="index.php" enctype="application/x-www-form-urlencoded" method="post">
